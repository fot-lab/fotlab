...
// "Center-weighted asterisk" metering glyph: a 20x14 rectangle frame (the ~0.5px corner radius is
// negligible at 1px stroke) around a full ring (radius 3) and a centre asterisk built from 3 line
// segments of length 4, each rotated 60° from the previous one (total diameter 4). This is the same
// as the "Center-asterisk" glyph with the ring added. All shapes are mutually centre-aligned on the
