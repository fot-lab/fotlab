...
// "Center-asterisk" metering glyph: a 20x14 rounded-rect frame (corner radius 1, 1px stroke drawn
// inward) around a centre asterisk built from 3 line segments of length 4, each rotated 60° from the
// previous one (total diameter 4). This is the same as the "Center-spot" glyph with the solid dot
// replaced by the asterisk. All shapes are mutually centre-aligned on the standard 24x24 grid.
