...
/**
 * The display modes of the library content region (`FOTLAB-UIXDES-000004` R9).
 *
 ...
 * the common Material library / file-manager range (1, 2, 3 columns are the explicitly
 ...
 * the default of R9.
 */
enum class LibraryLayoutMode(val columns: Int) {
