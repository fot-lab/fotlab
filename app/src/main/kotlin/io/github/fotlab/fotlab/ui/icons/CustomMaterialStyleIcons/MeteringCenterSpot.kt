...
// "Center-spot" metering glyph: a 20x14 rounded-rect frame (corner radius 1, 1px stroke drawn
// inward) around a solid dot of radius 1.5 at the centre. All shapes are mutually centre-aligned on
// the standard 24x24 grid. Hand-authored so the icon stays a plain monochrome ImageVector that
