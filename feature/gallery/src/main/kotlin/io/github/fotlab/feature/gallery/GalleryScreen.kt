...
/** Drawer width: 80% of this module's content region (`FOTLAB-UIXDES-000002` R3). */
private const val DrawerWidthFraction = 0.8f

/**
 * Placeholder module screen.
 *
 * The top app bar and the drawer are implemented **by this module**: this is the
 * module's own code, its own state and its own lifetime, per
 * `FOTLAB-UIXDES-000002` R1/R5 and the amended C1. Only the behaviour contract
 * (drawer icon left, overflow right, 80% width, never covering the bottom bar)
 * is shared.
 */
    ...
    Box(modifier = Modifier.fillMaxSize()) {
            ...
            topBar = {
                TopAppBar(
                    ...
                    actions = {
                        ...
                        IconButton(onClick = { /* TODO: module overflow entries */ }) {
                            Icon(
        ...
        if (drawerOpen) {
            ...
            Surface(
                ...
                Column {
                    // Module-private drawer content (R5): no app-level entries here.
