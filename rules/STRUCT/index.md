...
| `RAWTRP-SURVEY-000003` | External module study — RawTherapee callable surface WITHOUT patching: stable rtengine API (processImage/InitialImage/ProcessingJob/ImageSource virtuals), GUI-internal ImProcFunctions+ColorTemp (public grading/WB, no patch), and the unreachable demosaic core (kernels protected + final class) | `SURVEY` | Draft | P2 | [detail](rules/STRUCT/detail/RAWTRP-SURVEY-000003.md) |
<!-- Next sequence per category: STRUCT 000004, RAWDEV 000002, PIPELN 000003, DNGLAB-PIPELN 000003, FOTRAW 000002, UNIFFI 000002, DNGLAB-SURVEY 000005, RAPIDR-SURVEY 000012, EXIFTL-SURVEY 000002, RAWTRP-SURVEY 000004, RAWTRP-DECODE 000005. Append one row per new item; never reuse or renumber IDs. -->
