...
Master index of encoded build & CI/CD rules.

- Entry point and build/CI behaviour: [`rules/ACTION.md`](rules/ACTION.md)
- Detail files: [`rules/ACTION/detail/`](rules/ACTION/detail/)
